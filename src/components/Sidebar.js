        ...
        <div class="card-body">
            ...
            <div className='container'>
                ...
                <div className="card-text">                   
                    ...
                    <p><b>Database: </b>MySQL, Postgres, MongoDb, Redis</p>
                    <p><b>Web Technologies: </b>Bootstrap, AJAX, Nodejs, Graphql, Aws</p>
                    <p><b>Javascript Libraries/Frameworks: </b>React JS, Jquery, express js</p>
